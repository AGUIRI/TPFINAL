 ...
 * @author raguiri
 */
@WebServlet(name = "ClientState", urlPatterns = {"/ClientState"})
public class ClientState extends HttpServlet {
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {   // Trouver la valeur du paramètre HTTP customerID
                ...
                List<CustomerEntity> Lcustomer = dao.customersInState(state);
                if (Lcustomer == null) {
                    throw new Exception("Client inconnu");
                }
                // Afficher les propriétés du client         
                out.printf("<table id=\"t01\">\n" +
                "  <tr>\n" +
                "    <th>ID</th>\n" +
                "    <th>NAME</th>\n" +
                "    <th>Address</th>\n" +
